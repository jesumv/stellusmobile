...
//insercion en la tabla de actividades		
	    ...
	    $query=mysqli_query($mysqli, $sqlCommand) or die ("error en reporte de actividades: ".mysqli_error($mysqli)); 
		...
		if(!$query){echo '<script type="text/javascript">
	  					location.href="http://www.stellus.mx/system/php/error.php";
	  				</script>';}else{	
	  							echo '<script type="text/javascript">
	  							location.href="http://www.stellus.mx/system/php/exito.php";
	  				</script>';}
